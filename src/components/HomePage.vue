...
.hero-section::after {
  ...
  height: 700px;
  top: -80px;
  background: url("@/assets/fish.png") no-repeat center;
  background-size: contain;
  opacity: 0.15;
  filter: drop-shadow(0 0 20px rgba(44, 124, 185, 0.2));
