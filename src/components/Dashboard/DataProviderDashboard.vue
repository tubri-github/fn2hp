...
.header {
  ...
  /* Header.vue's global (un-scoped) .header leaks position:relative + z-index:1000
     onto this div, putting the page title over the nav's user dropdown. Drop out
     of that positioned layer so the nav dropdown stays on top. */
  position: static;
}
...
@media (max-width: 900px) {
  ...
  /* Stat cards wrap instead of being crushed into one non-wrapping row. */
  .stats-summary {
    flex-wrap: wrap;
  }
  .stat-card {
